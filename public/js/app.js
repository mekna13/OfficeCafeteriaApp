...
var alerMsg = document.querySelector('#success-alert');
...
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(); //Update the order 

var statuses = document.querySelectorAll('.status_timeline');
var time_status = document.querySelector('.time_status');
var hiddenInput = document.querySelector('#hiddenInput');
var order = hiddenInput ? hiddenInput.value : null;
order = JSON.parse(order);
var updateTime = document.createElement('small');
var takeAwayTime = document.createElement('span');
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      updateTime.innerText = ' --- ' + moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('hh:mm A');
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51IBBliEVy9aYOsQ8OzWFR56Ja7qcp3RGS7s5R9DCfHOgzce0yqsKVW6k7AAY33DnGnagKoliDntmQwxxz3gYXuJv00l5w6oNrj');
...
=======
__webpack_require__(/*! E:\Final OCA\OfficeCafeteriaApp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\Final OCA\OfficeCafeteriaApp\resources\scss\app.scss */"./resources/scss/app.scss");
>>>>>>> Stashed changes
